...
const Signup = () => {
    ...
    const {
      ...
      //Watch for password and confirmpassword
    ...
    return (
            ...
            <div className='flex h-screen items-center justify-center inline-container' >
                <form onSubmit={handleSubmit(onSubmit)} className='border border-white px-6 py-2 rounded-md space-y-3 w-96' >
                    ...
                    <div className='flex justify-between'>
                        <p>Have an account? <Link to="/login" className='text-blue-500 cursor-pointer underline hover:text-blue-300'>Login</Link></p>
                        <input type='submit' value="Signup" className='text-white bg-green-500 px-2 py-1 rounded-lg cursor-pointer hover:bg-green-400'/>
                    </div>
                </form>
            </div>
